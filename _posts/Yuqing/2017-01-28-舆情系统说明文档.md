...
### <font color="blue"><b>舆情系统服务器信息</b></font>

#### <font color="green"><b>[高考舆情系统](http://gk.skyclass.net)</b></font> - http://gk.skyclass.net
___
> * 物理机器两台：（均放在网络中心）	
    * 系统登录信息：
    * 帐号：admin
...
#### <font color="green"><b>[学校舆情系统]<b>(http://cee.skyclass.net)</font> - http://cee.skyclass.net
___
> * 虚拟机一台
...
> #### <font color="green">**物理机2**(117.32.155.55)</font>
    * mysql : yq
    * weibo爬虫  (计划任务)
    * run_chart  (计划任务)
