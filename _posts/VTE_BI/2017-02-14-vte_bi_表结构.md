...
db.clinic_fee_detail.createIndex({'$yearmon':1, 'doct.id':1, 'charge.date':1})
> * shard-key
db.createCollection('clinic_fee_detail')
sh.shardCollection('cdr.clinic_fee_detail', {'$yearmon':1, '$doct.id':1, 'charge.date':1})  //$yearmon : charge.date [没有为null]
```
>
...
db.ais_oper_reg.createIndex({'$yearmon':1, 'oper.id':1, 'oper.date':1})
> * shard-key
db.createCollection('ais_oper_reg')
sh.shardCollection('cdr.ais_oper_reg', {'$yearmon':1, 'oper.id':1, 'oper.date':1})  //$yearmon : oper.date
```
>
