...
db.register.createIndex({'$yearmon':1, 'doct.id':1})
> shard-key
...
db.clinic_diagnose.createIndex({'$yearmon':1, 'doct.id':1})
> shard-key
...
db.clinic_fee_detail.createIndex({'$yearmon':1, 'doct.id':1})
> shard-key
db.createCollection('clinic_fee_detail')
sh.shardCollection('cdr.clinic_fee_detail', {'$yearmon':1, '$doct.id':1})
```
>
...
db.clinic_medical_order.createIndex({'$yearmon':1, 'doct.id':1})
>shard-key
db.createCollection('clinic_medical_order')
sh.shardCollection('cdr.clinic_medical_order', {'$yearmon':1, '$doct.id':1}) 
```
>
...
db.inpatient_mo_exec_drug.createIndex({'$yearmon':1, 'doct.id':1})
> shard-key
db.createCollection('inpatient_mo_exec_drug')
sh.shardCollection('cdr.inpatient_mo_exec_drug', {'$yearmon':1, '$doct.id':1}) 
```
>
