...
>
```
# 此表 主要用来 记录字典项与cdr表中对应关系,主要记录了 使用的 ｃｄｒ表 和 字段名
```
>
...
>
```
# 此表主要　记录CDR手术ICD9编码表（内容为 xxx手术之类）
...
>
```
# 此表主要 记录CDR 科室, 主要是 子科室 与 父科室
```
>
> source_department [文档数:394]
>
```
# 此表主要 记录一附院原始科室，来自人工整理
# 其中　７４　条一级科室
...
>
```
# 此表用来　记录　病人信息（包括门诊/住院，以pid作为新的cdr病人主键）
# primary-key: _id(pid)
# 是否 Shard : D[待定]
>
...
>
```
# 此表主要　用来 一附院 card_no 与 cdr.pid 相对应起来
