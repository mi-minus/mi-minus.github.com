...
| 4. inpatient_fee_detail    |                   |  Y       |              |      |
| 5. clinic_medical_order    |                   |  Y       |              |      |
...
db.register.createIndex({'$yearmon':1, 'doct.id':1, 'reg_date':1})
> shard-key
db.createCollection('register')
sh.shardCollection("cdr.register", {'$yearmon':1,'$doct.id':1, 'reg_date':1})  //$yearmon : reg_date
```
>
...
db.clinic_diagnose.createIndex({'$yearmon':1, 'doct.id':1, 'diag_date':1})
> shard-key
db.createCollection('clinic_diagnose')
sh.shardCollection('cdr.clinic_diagnose', {'$yearmon':1, '$doct.id':1, 'diag_date':1})  //$yearmon : diag_date
```
>
...
db.clinic_fee_detail.createIndex({'$yearmon':1, 'doct.id':1, 'fee.date':1})
> shard-key
db.createCollection('clinic_fee_detail')
sh.shardCollection('cdr.clinic_fee_detail', {'$yearmon':1, '$doct.id':1, 'fee.date':1})  //$yearmon : fee.date
```
>
...
db.clinic_medical_order.createIndex({'$yearmon':1, 'doct.id':1, 'oper_date':1})
>shard-key
db.createCollection('clinic_medical_order')
sh.shardCollection('cdr.clinic_medical_order', {'$yearmon':1, '$doct.id':1, 'oper_date':1})  //$yearmon : oper_date
```
>
...
db.inpatient_mo_exec_drug.createIndex({'$yearmon':1, 'doct.id':1, 'mo_date':1})
> shard-key
db.createCollection('inpatient_mo_exec_drug')
sh.shardCollection('cdr.inpatient_mo_exec_drug', {'$yearmon':1, 'doct.id':1, 'mo_date':1})  //$yearmon : mo_date
```
>
...
db.inpatient_mo_exec_undrug.createIndex({'$yearmon':1, 'doct.id':1, 'mo_date':1})
> shard-key
db.createCollection('inpatient_mo_exec_undrug')
sh.shardCollection('cdr.inpatient_mo_exec_undrug', {'$yearmon':1, '$doct.id':1, 'mo_date':1})  //$yearmon : mo_date
```
>
...
db.inpatient_info.createIndex({'$yearmon':1, 'doct.id':1 ,'in_date':1})
> shard-key
db.createCollection('inpatient_info')
sh.shardCollection('cdr.inpatient_info', {'$yearmon':1, '$doct.id':1, 'in_date':1})  //$yearmon : in_date in_date 不为null, out_date　有部分为null
```
>
...
> index
db.inpatient_diagnose.createIndex({'_id.inpatient_id':1})
...
```
>
> inpatient_case [文档数:744470]  [**No-Shard**]  [**注意需要将Ｂｉ代码里的 inpatient_case_no_shard 改成 inpatient_case**]
>
```
...
db.inpatient_operation.createIndex({'$yearmon':1, 'doct_id':1, 'ops_date':1})
> shard-key
db.createCollection('inpatient_operation')
sh.shardCollection('cdr.inpatient_operation', {'$yearmon':1, 'doct_id':1, 'ops_date':1})  //$yearmon : ops_date
```
>
...
db.inpatient_ops_arrange.createIndex({'$yearmon':1, '_id.role_id':1, 'oper_date':1})
> shard-key
db.createCollection('inpatient_ops_arrange')
sh.shardCollection('cdr.inpatient_ops_arrange', {'$yearmon':1, '_id.role_id':1, 'oper_date':1})  //$yearmon : oper_date
```
>
...
db.inpatient_ops_case.createIndex({'$yearmon':1, '_id.seq_no':1, 'ops_date':1})
> shard-key
db.createCollection('inpatient_ops_case')
sh.shardCollection('cdr.inpatient_ops_case', {'$yearmon':1, '_id.seq_no':1, 'ops_date':1}) //$yearmon : ops_date
```
>
...
db.ais_oper_reg.createIndex({'$yearmon':1, 'oper.id':1, 'ops_date':1})
> shard-key
db.createCollection('ais_oper_reg')
sh.shardCollection('cdr.ais_oper_reg', {'$yearmon':1, 'oper.id':1, 'ops_date':1})  //$yearmon : ops_date
```
>
...
db.lis.createIndex({'$yearmon':1, 'test_order.id':1, 'input_time':1})
> shard-key
db.createCollection('lis')
sh.shardCollection('cdr.lis', {'$yearmon':1, 'test_order.id':1, 'input_time':1})  //$yearmon : input_time input_time没有为null
```
>
...
db.pacs_inpatientno.createIndex({'$yearmon':1, 'device_type':1, 'study_time':1})
> shard-key
db.createCollection('pacs_inpatientno')
sh.shardCollection('cdr.pacs_inpatientno', {'$yearmon':1, 'device_type':1, 'study_time':1}) //$yearmon : study_time
```
