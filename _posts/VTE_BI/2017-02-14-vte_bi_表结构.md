...
>
```
db.bed_stat.createIndex({'rpt_date':1,'_id.dept_id':1, 'out_num':1})
db.bed_stat.createIndex({'rpt_month':1,'_id.dept_id':1, 'out_num':1})
db.bed_stat.createIndex({'rpt_quarter':1,'_id.dept_id':1, 'out_num':1})
db.bed_stat.createIndex({'rpt_year':1,'_id.dept_id':1, 'out_num':1})
>
db.bed_stat.createIndex({'rpt_date':1,'_id.dept_id':1, 'bed_standard':1})
db.bed_stat.createIndex({'rpt_month':1,'_id.dept_id':1, 'bed_standard':1})
db.bed_stat.createIndex({'rpt_quarter':1,'_id.dept_id':1, 'bed_standard':1})
db.bed_stat.createIndex({'rpt_year':1,'_id.dept_id':1, 'bed_standard':1})
>
db.bed_stat.createIndex({'rpt_date':1,'_id.dept_id':1, 'out_transfer':1})
db.bed_stat.createIndex({'rpt_month':1,'_id.dept_id':1, 'out_transfer':1})
db.bed_stat.createIndex({'rpt_quarter':1,'_id.dept_id':1, 'out_transfer':1})
db.bed_stat.createIndex({'rpt_year':1,'_id.dept_id':1, 'out_transfer':1})
>
db.bed_stat.createIndex({'rpt_date':1,'_id.dept_id':1, 'end_patient_num':1})
db.bed_stat.createIndex({'rpt_month':1,'_id.dept_id':1, 'end_patient_num':1})
db.bed_stat.createIndex({'rpt_quarter':1,'_id.dept_id':1, 'end_patient_num':1})
db.bed_stat.createIndex({'rpt_year':1,'_id.dept_id':1, 'end_patient_num':1})
```
>
> clinic_count
>
```
db.clinic_count.createIndex({'_id.rpt_date':1, '_id.dept_id':1, 'count':1})
db.clinic_count.createIndex({'rpt_month':1, '_id.dept_id':1, 'count':1})
db.clinic_count.createIndex({'rpt_quarter':1, '_id.dept_id':1, 'count':1})
db.clinic_count.createIndex({'rpt_year':1, '_id.dept_id':1, 'count':1})
```
>
> clinic_feeinfo_stat
>
```
db.clinic_feeinfo_stat.createIndex({'_id.rpt_date':1, '_id.doct_dept_id':1, '_id.doct_id':1, 'total_cost':1})
db.clinic_feeinfo_stat.createIndex({'rpt_month':1, '_id.doct_dept_id':1, '_id.doct_id':1, 'total_cost':1})
db.clinic_feeinfo_stat.createIndex({'rpt_quarter':1, '_id.doct_dept_id':1, '_id.doct_id':1, 'total_cost':1})
db.clinic_feeinfo_stat.createIndex({'rpt_year':1, '_id.doct_dept_id':1, '_id.doct_id':1, 'total_cost':1})
```
...
>
```
db.doctor_stat.createIndex({'rpt_year':1, 'dept_id':1 , '_id.doctor_id':1, 'sum_count':1})
db.doctor_stat.createIndex({'rpt_month':1, 'dept_id':1 , '_id.doctor_id':1, 'sum_count':1})
db.doctor_stat.createIndex({'rpt_quarter':1, 'dept_id':1 , '_id.doctor_id':1, 'sum_count':1})
>
...
>
```
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'surgery_count':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'dead_count':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_count':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_dead_count':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'count':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'days':1})
db.inpatient_without_dept.createIndex({'_id.rpt_date':1, '_id.patient_souce':1, '_id.payment_type':1, 'reclaim_count':1})
>
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'surgery_count':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'dead_count':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_count':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_dead_count':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'count':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'days':1})
db.inpatient_without_dept.createIndex({'rpt_month':1, '_id.patient_souce':1, '_id.payment_type':1, 'reclaim_count':1})
>
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'surgery_count':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'dead_count':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_count':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_dead_count':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'count':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'days':1})
db.inpatient_without_dept.createIndex({'rpt_quarter':1, '_id.patient_souce':1, '_id.payment_type':1, 'reclaim_count':1})
>
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'surgery_count':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'dead_count':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_count':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'oper_dead_count':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'gt30_count':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'count':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'days':1})
db.inpatient_without_dept.createIndex({'rpt_year':1, '_id.patient_souce':1, '_id.payment_type':1, 'reclaim_count':1})
```
>
> operation_dead_stat
>
```
db.operation_dead_stat.createIndex({'_id.rpt_date':1, '_id.dept_id':1, 'dead_count':1})
db.operation_dead_stat.createIndex({'_id.rpt_date':1, '_id.dept_id':1, 'oper_count':1})
>
db.operation_dead_stat.createIndex({'rpt_month':1, '_id.dept_id':1, 'dead_count':1})
db.operation_dead_stat.createIndex({'rpt_month':1, '_id.dept_id':1, 'oper_count':1})
>
db.operation_dead_stat.createIndex({'rpt_quarter':1, '_id.dept_id':1, 'dead_count':1})
db.operation_dead_stat.createIndex({'rpt_quarter':1, '_id.dept_id':1, 'oper_count':1})
>
db.operation_dead_stat.createIndex({'rpt_year':1, '_id.dept_id':1, 'dead_count':1})
db.operation_dead_stat.createIndex({'rpt_year':1, '_id.dept_id':1, 'oper_count':1})
```
>
> operation_stat
>
```
db.operation_stat.createIndex({'_id.rpt_date':1, '_id.dept_id':1, 'blood_amount':1})
db.operation_stat.createIndex({'_id.rpt_date':1, '_id.dept_id':1, 'dead_count':1})
db.operation_stat.createIndex({'_id.rpt_date':1, '_id.dept_id':1, 'oper_count':1})
>
db.operation_stat.createIndex({'rpt_month':1, '_id.dept_id':1, 'blood_amount':1})
db.operation_stat.createIndex({'rpt_month':1, '_id.dept_id':1, 'dead_count':1})
db.operation_stat.createIndex({'rpt_month':1, '_id.dept_id':1, 'oper_count':1})
>
db.operation_stat.createIndex({'rpt_quarter':1, '_id.dept_id':1, 'blood_amount':1})
db.operation_stat.createIndex({'rpt_quarter':1, '_id.dept_id':1, 'dead_count':1})
db.operation_stat.createIndex({'rpt_quarter':1, '_id.dept_id':1, 'oper_count':1})
>
db.operation_stat.createIndex({'rpt_year':1, '_id.dept_id':1, 'blood_amount':1})
db.operation_stat.createIndex({'rpt_year':1, '_id.dept_id':1, 'dead_count':1})
db.operation_stat.createIndex({'rpt_year':1, '_id.dept_id':1, 'oper_count':1})
```
